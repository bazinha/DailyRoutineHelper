...
class EditCopyWidget extends StatefulWidget {
  const EditCopyWidget({Key? key}) : super(key: key);

  @override
  _EditCopyWidgetState createState() => _EditCopyWidgetState();
}
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsuarioRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuarioRow> editCopyUsuarioRowList = snapshot.data!;
        final editCopyUsuarioRow = editCopyUsuarioRowList.isNotEmpty
            ? editCopyUsuarioRowList.first
            : null;
