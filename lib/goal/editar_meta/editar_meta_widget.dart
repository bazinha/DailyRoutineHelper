...
class EditarMetaWidget extends StatefulWidget {
  ...
  @override
  _EditarMetaWidgetState createState() => _EditarMetaWidgetState();
}
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsuarioRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuarioRow> editarMetaUsuarioRowList = snapshot.data!;
        final editarMetaUsuarioRow = editarMetaUsuarioRowList.isNotEmpty
            ? editarMetaUsuarioRowList.first
            : null;
                          ...
                          onPressed: () async {
                            await MetaTable().update(
                              data: {
                                ...
                                'codigo_usuario': editarMetaUsuarioRow?.codigo,
