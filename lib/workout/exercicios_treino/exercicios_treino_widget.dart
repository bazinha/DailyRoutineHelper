                    ...
                    child: Padding(
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  Align(
                                    alignment: AlignmentDirectional(0.22, 0.14),
                          ...
                          Align(
                            alignment: AlignmentDirectional(0.22, 0.91),
                            child: FFButtonWidget(
                              onPressed: () async {
                                context.pushNamed(
                                  'EditWorkout',
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Align(
                            alignment: AlignmentDirectional(0.81, -4.81),
                            child: FlutterFlowIconButton(
                              borderColor: Colors.transparent,
                              borderRadius: 20.0,
                              borderWidth: 1.0,
                          ...
                          Align(
                            alignment: AlignmentDirectional(-0.41, -1.15),
                            child: FlutterFlowIconButton(
                              borderColor: Colors.transparent,
                              borderRadius: 20.0,
                              borderWidth: 1.0,
                          ...
                          Align(
                            alignment: AlignmentDirectional(0.17, -2.66),
                            child: FlutterFlowIconButton(
                              borderColor: Colors.transparent,
                              borderRadius: 20.0,
                              borderWidth: 1.0,
