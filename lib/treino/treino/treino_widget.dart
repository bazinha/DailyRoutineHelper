...
class TreinoWidget extends StatefulWidget {
  const TreinoWidget({Key? key}) : super(key: key);

  @override
  _TreinoWidgetState createState() => _TreinoWidgetState();
}
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsuarioRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuarioRow> treinoUsuarioRowList = snapshot.data!;
        final treinoUsuarioRow =
            treinoUsuarioRowList.isNotEmpty ? treinoUsuarioRowList.first : null;
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed('AdicionarTreino');
                      },
                      text: 'Adicionar',
                            ...
                            child: Padding(
                              ...
                              child: FutureBuilder<List<TreinoRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<TreinoRow> columnTreinoRowList =
                                      snapshot.data!;
                                  return SingleChildScrollView(
                                    child: Column(
                                      ...
                                      children: List.generate(
                                          columnTreinoRowList.length,
                                          (columnIndex) {
                                        final columnTreinoRow =
                                            columnTreinoRowList[columnIndex];
                                        return Align(
                                          alignment:
