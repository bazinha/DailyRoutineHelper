...
import 'adicionar_treino_model.dart';
export 'adicionar_treino_model.dart';

class AdicionarTreinoWidget extends StatefulWidget {
  const AdicionarTreinoWidget({Key? key}) : super(key: key);

  @override
  _AdicionarTreinoWidgetState createState() => _AdicionarTreinoWidgetState();
}

class _AdicionarTreinoWidgetState extends State<AdicionarTreinoWidget> {
  late AdicionarTreinoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdicionarTreinoModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsuarioRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuarioRow> adicionarTreinoUsuarioRowList = snapshot.data!;
        final adicionarTreinoUsuarioRow =
            adicionarTreinoUsuarioRowList.isNotEmpty
                ? adicionarTreinoUsuarioRowList.first
                : null;
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await TreinoTable().insert({
                          'codigo_usuario': adicionarTreinoUsuarioRow?.codigo,
