...
class EditarRefeicaoWidget extends StatefulWidget {
  ...
  @override
  _EditarRefeicaoWidgetState createState() => _EditarRefeicaoWidgetState();
}
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsuarioRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuarioRow> editarRefeicaoUsuarioRowList = snapshot.data!;
        final editarRefeicaoUsuarioRow = editarRefeicaoUsuarioRowList.isNotEmpty
            ? editarRefeicaoUsuarioRowList.first
            : null;
