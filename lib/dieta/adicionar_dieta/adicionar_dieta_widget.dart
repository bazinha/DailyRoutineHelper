...
import 'adicionar_dieta_model.dart';
export 'adicionar_dieta_model.dart';

class AdicionarDietaWidget extends StatefulWidget {
  const AdicionarDietaWidget({Key? key}) : super(key: key);

  @override
  _AdicionarDietaWidgetState createState() => _AdicionarDietaWidgetState();
}

class _AdicionarDietaWidgetState extends State<AdicionarDietaWidget> {
  late AdicionarDietaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdicionarDietaModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsuarioRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuarioRow> adicionarDietaUsuarioRowList = snapshot.data!;
        final adicionarDietaUsuarioRow = adicionarDietaUsuarioRowList.isNotEmpty
            ? adicionarDietaUsuarioRowList.first
            : null;
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await DietaTable().insert({
                          'codigo_usuario': adicionarDietaUsuarioRow?.codigo,
