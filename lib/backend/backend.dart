...
import 'schema/rotina_record.dart';
...
export 'schema/rotina_record.dart';
...
/// Functions to query RotinaRecords (as a Stream and as a Future).
Future<int> queryRotinaRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RotinaRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RotinaRecord>> queryRotinaRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      RotinaRecord.collection,
      RotinaRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<RotinaRecord>> queryRotinaRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
